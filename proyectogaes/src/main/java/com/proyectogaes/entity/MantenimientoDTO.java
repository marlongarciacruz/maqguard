...
/**
 * DTO: Mantenimiento con nombre de máquina y técnico (resultado de JOIN).
 * Se usa en las vistas del técnico: mismantenimientos y historialtec.
 */
public class MantenimientoDTO {
    ...
    // Constructor completo (usado en las queries JPQL)
    ...
    // Constructor para historial (con nombre técnico)
